...
contract DispatchReceiver is ITeleporterReceiver {
    ...
    function receiveTeleporterMessage(
        ...
        _sendMessage(address(0x124eDB77c52c7fb707AeeF7695342D5B3f999d55), message);
    }

    function _sendMessage(address destinationAddress, bytes calldata message) private {
